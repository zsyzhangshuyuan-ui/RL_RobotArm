	...
	public class ObjectReferencePicker : SkinnedWindow, IListViewAdapter
	{
...
#if REALVIRTUAL_PLANNER
		private static SkinController controller;
#endif
		public static ObjectReferencePicker Instance
		{
			get
			{
				...
				if( m_instance == null )
				{
					m_instance = Instantiate( Resources.Load<ObjectReferencePicker>( "ObjectReferencePickerRV" ) );
...
#if REALVIRTUAL_PLANNER
			if (controller != null)
				//Skin = controller.GetCurrentInspectorSkin();
#else
