...
namespace realvirtual
{
    public class FirstPersonController : MonoBehaviour
    {
        ...
        public bool RotateHeadLeftMouseButtonNeeded = false;
        ...
        void Setup()
        {
            ...
            _characterController.center = new Vector3(0, Size / 2, 0);
            Head.transform.localPosition = new Vector3(0, Size - 0.1f, 0);
        }
        ...
        void Update()
        {
            ...
            if (!RotateHeadLeftMouseButtonNeeded || (RotateHeadLeftMouseButtonNeeded && Input.GetMouseButton(0)))
            {
                xRotation -= mouseY;
