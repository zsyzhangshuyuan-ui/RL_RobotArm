...
{
    [CustomEditor(typeof(realvirtual.opencommissioning.OCLinkDrivePosition), false), CanEditMultipleObjects]
    // ReSharper disable once InconsistentNaming
    public class OCLinkDrivePosition : UnityEditor.Editor
    {
        public override VisualElement CreateInspectorGUI()
        {
            var component = target as realvirtual.opencommissioning.OCLinkDrivePosition;
