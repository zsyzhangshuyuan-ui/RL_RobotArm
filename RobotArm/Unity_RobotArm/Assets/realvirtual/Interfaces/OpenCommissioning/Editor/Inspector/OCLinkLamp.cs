...
{
    [CustomEditor(typeof(realvirtual.opencommissioning.OCLinkLamp), false), CanEditMultipleObjects]
    // ReSharper disable once InconsistentNaming
    public class OCLinkLamp : UnityEditor.Editor
    {
        public override VisualElement CreateInspectorGUI()
        {
            var component = target as realvirtual.opencommissioning.OCLinkLamp;
            ...
            groupReferences.Add(new PropertyField{bindingPath = "_lamp"});
